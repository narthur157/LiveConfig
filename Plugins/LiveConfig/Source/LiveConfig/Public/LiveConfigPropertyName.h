 ...
 */
USTRUCT(BlueprintType, Meta = (HasNativeMake = "/Script/LiveConfig.LiveConfigLibrary.MakeLiteralLiveConfigProperty", HasNativeBreak = "/Script/LiveConfig.LiveConfigLibrary.GetProperty", DisableSplitPin))
